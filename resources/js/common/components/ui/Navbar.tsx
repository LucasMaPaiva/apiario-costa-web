        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a
              ...
              className="inline-flex items-center px-6 py-2 rounded-full bg-green-600 text-brand-white text-xs font-bold hover:bg-green-700 transition-all gap-2"
            >
        ...
        >
          <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center px-3 py-3 text-brand-mel font-bold"
            >
