                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                        ...
                        <div className="space-y-2">
                            ...
                            <input 
                                ...
                                className="w-full px-5 py-4 bg-bg-main/50 border border-border rounded-xl focus:outline-none focus:border-brand-mel focus:ring-4 focus:ring-brand-mel/10 transition-all font-medium text-sm text-text-secondary italic" 
                            />
                        </div>
                    </div>
