...
<head>
    ...
    <style>
        ...
        .badge { display: inline-block; background: #dcfce7; color: #166534; border-radius: 4px; padding: 2px 10px; font-size: 13px; font-weight: bold; }
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p>
            Recebemos a confirmação do pagamento do seu pedido <strong>#{{ $order->id }}</strong>.
            Logo logo estaremos preparando seu pedido!
        </p>

        <p>Status do pedido: <span class="badge">Pago</span></p>
